...
<HTML>
				...
				$.ajax({
					...
					"success":function (data) {
						...
						for (var i = 0;i<data.length;i++){
							context += "<option value=\""+data[i].cid+"\" name='cid'>"+data[i].cname+"</option>";
						}
						$("#categoryList").html(context);
					},
					"dataType":"json"
				});
			});
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/product?method=adminProduct" method="post" enctype="multipart/form-data">
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<select name="cid" id="categoryList">
