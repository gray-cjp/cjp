	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form  id="checkform" class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath}/user?method=registerUser" method="post">
					...
					<div class="form-group opt">
						...
						<div class="col-sm-6">
                            ...
                            <label class="error" style="display: none" for="sex">性别必须勾选</label>
						</div>
					</div>
					<div class="form-group">
