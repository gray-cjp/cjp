...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<c:forEach items="${pageBean.list}" var="pro">
			<div class="col-md-2" style="height: 250px;">
				<a href="${pageContext.request.contextPath}/product?method=categoryInfo&Pid=${pro.pid}&currentPage=${pageBean.currentPage}&CategoryCid=${CategoryCid}">
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pageBean.currentPage!=1}">
				<li>
					<a href="${pageContext.request.contextPath}/product?method=productListByCid&CategoryCid=${CategoryCid}&currentPage=${pageBean.currentPage-1}"
			...
			<c:forEach begin="1" end="${pageBean.totalPage}" var="i">
				...
				<c:if test="${i!=pageBean.currentPage}">
					<li>
						<a href="${pageContext.request.contextPath}/product?method=productListByCid&CategoryCid=${CategoryCid}&currentPage=${i}">${i}</a>
					</li>
				</c:if>
			</c:forEach>
	...
	<div
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				<c:forEach items="${historyProdcutList }" var="historyPro">
